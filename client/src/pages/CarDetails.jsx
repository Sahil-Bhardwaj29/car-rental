...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      <button className='flex items-center gap-2 cursor-pointer text-gray-500 mb-6' onClick={()=>{
        navigate(-1) 
      }}>
      ...
      <div className='grid grid-clos-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg_col-span-2'>
          <img src={car.image} alt='' className='w-full h-auto object-cover rounded-xl mb-6 shadow-md md:max-h-100'/>
          ...
          <div>
            <div >
              <h1 className='text-xl font-medium mb-6'>Description</h1>
              <p className='text-gray-500'>{car.description}</p>
            </div>
            <div>
              <h1 className='text-xl font-medium mb-6'>Features</h1>
              <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                {
                  ["360-degree camera","Bluetooth connectivity","Cruise control","Heated seats","Keyless entry","LED headlights","Parking sensors","Rearview camera","Sunroof","USB ports"].map((item)=>(
