        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {bookings.map((booking,index)=>(
              <tr key={index} className='border-t border-borderColor hover:bg-gray-50 transition text-gray-500'>
                <td className='p-3 flex items-center gap-3'>
                  <img src={booking.car.image} alt={booking.car.model} className='h-12 w-12 object-cover aspect-square rounded-md'/>
