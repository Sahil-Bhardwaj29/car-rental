  ...
  return (
    <div>
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title='Available Cars' subtitle='Browse our selection of premium vehciles available for your next adventure'/>
        <div className='flex items-center border border-borderColor bg-white mt-6 px-4 max-w-140 w-full h-12 rounded-full shadow'>
